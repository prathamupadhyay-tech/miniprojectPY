...
__all__ = [ 'Picture', 'Color', 'Monochrome', 'OLE_HANDLE',
           'Unchecked', 'OLE_XSIZE_CONTAINER', 'FONTBOLD',
           'OLE_XSIZE_PIXELS', 'FONTNAME', 'OLE_ENABLEDEFAULTBOOL',
           'IFontEventsDisp', 'Default', 'FONTSTRIKETHROUGH',
           'OLE_YSIZE_CONTAINER', 'IPictureDisp', 'OLE_TRISTATE',
           'OLE_YPOS_CONTAINER', 'LoadPictureConstants',
           'OLE_YSIZE_HIMETRIC', 'OLE_YPOS_HIMETRIC', 'StdPicture',
           'FONTUNDERSCORE', 'IFont', 'Checked', 'OLE_XPOS_HIMETRIC',
           'OLE_XPOS_PIXELS', 'FONTSIZE', 'OLE_COLOR', 'IFontDisp',
           'FontEvents', 'OLE_CANCELBOOL', 'OLE_OPTEXCLUSIVE', 'Font',
           'FONTITALIC', 'Gray', 'OLE_XSIZE_HIMETRIC',
           'OLE_XPOS_CONTAINER', 'OLE_YSIZE_PIXELS', 'VgaColor',
           'StdFont', 'IPicture', 'OLE_YPOS_PIXELS']
from comtypes import _check_version; _check_version('1.1.11', 1575709663.649906)
